  ...
  return (
    <div className="navbar">
      ...
      <ul  ref={menuRef}className="navbar-list">
        ...
        <li><AnchorLink  className="anchor-link"  offset={50} href="#Service"><p onClick={()=> setMenu("Services")}>Services</p></AnchorLink>{menu==="Services"?<img src={underline} alt="" className="logo" />:<></>}</li>
        <li><AnchorLink  className="anchor-link"  offset={50} href="#MyWork"><p onClick={()=> setMenu("Mywork")}>Portfolio</p></AnchorLink>{menu==="Mywork"?<img src={underline} alt="" className="logo" />:<></>}</li>
